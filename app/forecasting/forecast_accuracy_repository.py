            ...
            conn.executemany(
                ...
                [
                    (
                        ...
                        item["sample_size"],
                        item.get("direction_accuracy"),
                        item.get("mae"),
                        item.get("rmse"),
                        item.get("mape"),
                        item.get("median_absolute_error"),
                        item.get("entry_touch_accuracy"),
                        item.get("stop_before_entry_error_rate"),
                        item.get("calibration_score"),
                        1 if item.get("enough_data") else 0,
                        item.get("min_required_samples", 30),
