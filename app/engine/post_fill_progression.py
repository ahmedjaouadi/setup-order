...
class PostFillProgression:
    ...
    def mark_in_position(self, setup_id: str, *, protection_verified: bool) -> None:
        """Write IN_POSITION only if the caller passes protection_verified=True.
        This method does not itself verify protection; it trusts the flag.
        The caller is responsible for grounding protection_verified in an
        actual check (audit 19, obstacle 3: an unconditional write here would
